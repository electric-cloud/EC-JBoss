...
# esx.cgi -
#
# Get/set EC-IIS configuration info for UI
#
...
################################
# getCfgList - Return the list of configurations from Tomcat
#
# Arguments:
#   -
#
...
sub getCfgList {
    ...
    my $gcfg = new ElectricCommander::PropDB($::ec,"/projects/@PLUGIN_NAME@/jboss_cfgs");
    ...
    foreach my $cfg (keys  %cfgs) {
        my $url = $gcfg->getCol("$cfg/jboss_url");
        $xml .= "  <cfg>\n";
        $xml .= "     <name>$cfg</name>\n";
