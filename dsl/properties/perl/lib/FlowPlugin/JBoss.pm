...
use base qw/FlowPDF/;
use FlowPDF::Log;
use EC::JBoss;      # TODO: remove after full port to PDK
use EC::Logger;     # TODO: remove after full port to PDK
use Carp;           # TODO: remove after full port to PDK
use File::Basename;
...
sub checkConnection {
    ...
    my $logger = EC::Logger->new(log_level_old_api_value => $p->{log_level});
