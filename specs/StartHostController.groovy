...
class StartHostController extends PluginTestHelper {
    ...
    def additionalOptions = [
        ...
        'сustomLogs' : (EnvPropertiesHelper.getOS()=='UNIX') ? ' -Djboss.domain.log.dir=/tmp/qa' : ' -Djboss.domain.log.dir=C:/tmp/qa',
        'empty': '',
    ...
    def jobLogs = [
        ...
        'bootErrors': ["One or more services were unable to start due to one or more indirect dependencies not being available", "Could not start http listener", "Address already in use"],
    ...
    def "StartHostController - start jboss: success and warning, boot errors"() {
        ...
        testCases.systemTest2.name  | defaultConfigName | domainConfigs.'default' | hostConfigs.'default'    | jbossHostNames.'master'   | startupScripts.'default'  | logFileLocations.'custom'  | additionalOptions.'docker'+additionalOptions.'сustomLogs' | "success"         | summaries.'default'                 | jobLogs.'customLogs'
        ...
        testCases.systemTest9.name  | defaultConfigName | domainConfigs.'default' | hostConfigs.'bootErrors' | jbossHostNames.'master'   | startupScripts.'default'  | logFileLocations.'wrong'   | additionalOptions.'docker'+additionalOptions.'сustomLogs' | "warning"         | summaries.'wrongLogsAndBootErrors'  | jobLogs.'wrongLogs'
        testCases.systemTest10.name | defaultConfigName | domainConfigs.'default' | hostConfigs.'default'    | jbossHostNames.'master'   | startupScripts.'default'  | logFileLocations.'wrong'   | additionalOptions.'docker'+additionalOptions.'сustomLogs' | "warning"         | summaries.'wrongLogs'               | jobLogs.'wrongLogs'
