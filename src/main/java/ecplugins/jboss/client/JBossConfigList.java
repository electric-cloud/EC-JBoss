...
// JBossConfigList.java --
//
// JBossConfigList.java is part of ElectricCommander.
//
...
public class JBossConfigList
{

    //~ Instance fields --------------------------------------------------------

    private final Map<String, JBossConfigInfo> m_configInfo =
        new TreeMap<String, JBossConfigInfo>();
    ...
    public void addConfig(
            ...
            String configUrl)
    {
        m_configInfo.put(configName, new JBossConfigInfo(configUrl));
    }
    ...
    private class JBossConfigInfo
    {
        ...
        public JBossConfigInfo(String url)
        {
            m_url = url;
        }
    }
